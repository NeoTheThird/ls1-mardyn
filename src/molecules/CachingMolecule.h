...
#ifndef CACHINGMOLECULE_H_
#define CACHINGMOLECULE_H_
...
public:
	...
	CachingMolecule(const CachingMolecule& m);
	 ...
	 */
	double dist2(const CachingMolecule& molecule2, double dr[3]) const {
		double d2 = 0.;
