...
// VISWriter::VISWriter(unsigned long writeFrequency, string filename, unsigned long numberOfTimesteps,
// bool incremental) {
VISWriter::VISWriter(unsigned long writeFrequency, std::string outputPrefix, bool incremental) {
	// _filename = filename;
