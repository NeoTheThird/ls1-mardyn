...
#ifndef HYBRIDREORDEREDBLOCKTRAVERSE_H_
#define HYBRIDREORDEREDBLOCKTRAVERSE_H_
...
class HybridReorderedBlockTraverse {
public:
	...
	HybridReorderedBlockTraverse(
            ParticleContainer* moleculeContainer, std::vector<HybridCell>& cells,
