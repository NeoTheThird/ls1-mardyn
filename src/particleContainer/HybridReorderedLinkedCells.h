...
#ifndef HYBRIDREORDEREDLINKEDCELLS_H_
#define HYBRIDREORDEREDLINKEDCELLS_H_
 ...
 */
class HybridReorderedLinkedCells : public ParticleContainer {
public:
...
private:
	...
	std::vector<HybridCell> _cells; //!< Vector containing all cells (including halo)
	...
	HybridReorderedBlockTraverse _blockTraverse;
